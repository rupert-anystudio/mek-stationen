const props = {
  title: 'Lebende Brücken',
  assetFolder: 'lebendebruecken',
  titleParts: {
    de: [
      { offset: .8, value: 'Wurzeln' },
      { offset: 0, value: 'schlagen' },
      { offset: 2.6, value: 'Brücken' },
    ],
    en: [
      { offset: 1.9, value: 'Roots' },
      { offset: 0, value: 'build' },
      { offset: 2.4, value: 'bridges' },
    ],
  },
  chapters: [
    {
      titleParts: {
        de: [
          { offset: .8, value: 'Lebende' },
          { offset: 0, value: 'Brücken' },
        ],
        en: [
          { offset: .8, value: 'Living' },
          { offset: 0, value: 'Bridges' },
        ],
      },
      content: [
        {
        ...
        },
        {
          type: 'quote',
          value: {
            de: 'Lebende Brücken sind sehr komplexe Bauwerke. Sie entstehen, wenn Menschen die Luftwurzeln von Bäumen miteinander verschlingen und verflechten.',
            en: 'Living bridges are very complex structures. They are made when people intertwine and plait the aerial roots of trees.',
          },
        },
        {
          type: 'text',
          value: {
            de: 'Sobald die Luftwurzeln eine bestimmte Länge erreicht haben, werden sie dafür von Menschen miteinander verkreuzt, geflochten und entlang von Bambusstäben geführt. Anschließend wachsen sie langsam weiter. Teilweise verbinden sie sich auch und wachsen ineinander. Man nennt dies Inoskulation. Dabei müssen die Menschen immer wieder alte und neue Wurzeln ver- und einflechten. Auch die Kraft der Pflanzen spielt dabei eine große Rolle. Sie gilt es zu nutzen und zu steuern.',
            en: 'Once the aerial roots have reached a certain length, people can interweave them for this purpose, plait them and guide them along bamboo poles. Then, they continue to grow slowly. Sometimes they join and grow into each other as well. This is known as inosculation. In the process, old and new roots need to be woven together again and again. The strength of the plants also plays a key role, which has to be exploited and controlled. ',
          },
        },
        {
          type: 'text',
          value: {
            de: 'Bis eine lebende Brücke fertig gebaut ist, vergeht viel Zeit: Erst nach circa 30 Jahren ist sie stabil und belastbar. So verbinden diese Bauwerke nicht nur Menschen an unterschiedlichen Orten, sondern auch Menschen über Generationen hinweg.',
            en: 'It takes a long time for a living bridge to be built: about 30 years for it to become stable and load-bearing. These structures not only connect people in different places, therefore, but also people across generations.',
          },
        },
        {
          type: 'text',
        ...
        },
        {
          type: 'text',
          value: {
            de: 'Wie Morningstar Khongtaw setzen sich Doktorand*innen an der TU München wie Wilfrid Middleton für die lebenden Brücken ein. Sie erforschen die traditionelle Ingenieurskunst und das bauliche Fachwissen der Khasi und Jaintia, die in die Brücken eingeflossen sind. Dazu schauen sie sich die einzelnen Brücken genau an und fertigen Detailskizzen, die sie anschließend digitalisieren, kartographieren und auswerten.',
            en: 'Like Morningstar Khongtaw, PhD students at the TU Munich including Wilfrid Middleton are committed to the living bridges. They are researching into the traditional engineering and construction expertise of the Khasi and Jaintia people that goes into the bridges. To do so, they are looking closely at the individual bridges and making detailed sketches, which are then digitised, mapped and evaluated.',
          },
        },
        {
          type: 'images',
    ...
    },
    {
      titleParts: {
        de: [
          ...
          { offset: 0, value: 'durch Tourismus' },
        ],
        en: [
      ...
      content: [
        {
          type: 'quote',
          value: {
            de: `Die lebenden Brücken der Khasi faszinieren nicht nur Forscher*innen. Sie ziehen immer mehr Tourist*innen an – aus Indiens wachsender Mittelschicht und aus aller Welt.`,
            en: `The living bridges of the Khasi are not only fascinating for researchers. They are attracting more and more tourists – from India's growing middle class and other visitors from all over the world.`,
          },
        },
        {
          type: 'text',
          value: {  
            de: 'Einerseits profitieren einige der Dörfer von diesen Verflechtungen mit den weltweiten Tourismusströmen. Andererseits sind weder die Brücken noch die Infrastruktur vor Ort für eine große Zahl an Besucher*innen ausgelegt.',
            en: 'Some of the villages benefit from such interconnections with global tourism. On the other hand, however, neither the bridges nor the local infrastructure are designed to cope with large numbers of visitors.',
          },
        },
        {
          type: 'text',
          value: {  
            de: 'Nicht alle Dorfbewohner*innen profitieren davon und auch die Natur sowie die Brücken leiden darunter.',
      ...
      content: [
        {
          type: 'quote',
          value: {
            de: 'Auch in anderen Regionen haben die Menschen durch Verflechten und Verdichten von lebenden Pflanzen ihre Umgebung gestaltet. In Nieheim in Nordrhein-Westfalen wurden über Jahrhunderte sehr stabile Hecken aus lebenden Weiden- und Haselruten verknotet und verflochten.',
            en: 'People in other regions have also shaped their surroundings by interlacing and densifying living plants. In Nieheim in North Rhine-Westphalia, stable hedges of living willow and hazel rods have been knotted and interwoven for centuries.',
          },
        },
        {
          type: 'text',
        ...
        },
        {
          type: 'quote',
          value: {
            de: 'Tanzlinden oder auch geleitete Linden sind große Bäume, deren Äste mit einer Holzkonstruktion in Form gebracht werden.',
            en: 'Dance lime trees or guided lime trees are large trees whose branches are shaped using a wooden construction.',
          },
        },
        {
          type: 'text',
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'quote',
          value: {
            de: 'Die Klimakrise beschäftigt auch die Baubranche. Das junge Forschungsfeld der innovativen Baubotanik erforscht deshalb, wie man mit verflochtenen und verkreuzten Stämmen und Zweigen lebender Pflanzen, die schließlich miteinander verwachsen, in die Höhe bauen kann.',
            en: 'The climate crisis is also a concern for the construction industry. The young research field of innovative Baubotanik is therefore investigating how to build upwards using the interwoven and crossed stems and branches of living plants that will eventually grow together.',
          },
        },
        {
          type: 'images',
        ...
        },
        {
          type: 'quote',
          value: {
            de: 'Führend in diesem Feld ist Prof. Ferdinand Ludwig. An der Technischen Universität München probiert er aus, wie sich Weiden oder Platanen als Außenwand nutzen lassen:',
            en: 'Prof. Ferdinand Ludwig is leading in this field. At the Technical University of Munich, he is trying out ways to use willows or sycamores as exterior walls',
          },
        },
        {
          type: 'video',
        ...
        },
        {
          type: 'text',
          value: {
            de: 'Auch hier ist es wie bei den Brücken der Khasi und Jaintia in Indien: Bis ein Gebäude mit Hilfe von Baubotanik gebaut ist, vergehen viele Jahre. Durch sie entsteht ein Beziehungsgeflecht zwischen Bäumen, Gebäuden und Menschen verschiedener Generationen, zwischen Natur und Kultur.',
            en: 'This is also like the Khasi and Jaintia bridges in India: many years pass before a building is constructed with the help of Baubotanik. It creates a network of relationships between trees, buildings and people of different generations; between nature and culture.',
          },
        },
        {
          type: 'images',
